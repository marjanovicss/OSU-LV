...
# jer vrati dataframe zbog duple [] od gore
...
# a)Pomocu stup ´ castog dijagrama prikažite koliko primjera postoji za svaku klasu (vrstu ˇpingvina) u skupu podataka za ucenje i skupu podataka za testiranje.
...
# c)  Pronadite u atributima izgra ¯ denog modela parametre modela. Koja je razlika u odnosu na ¯binarni klasifikacijski problem iz prvog zadatka?
# zbog broja klasa (3), ima 3 (za svaku klasu po jedan, jer je multinomial)(1xk dimenzije), kod binarne klasifikacije je bio 1 element(1 klasa)
...
# d)  Pozovite funkciju plot_decision_region pri cemu joj predajte podatke za u ˇ cenje i ˇizgradeni model logisticke regresije. Kako komentirate dobivene rezultate?
